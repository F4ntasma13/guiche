let contadorG: number = 0;
var contadorP: number = 0;
var contadorI: number = 0;
let tickets: string[] = [];
var clientesAtendidos: string[] = [];
...
const logar = (): void => {
    ...
    let botoesAtn = document.getElementsByClassName("botoesAtendimento") as HTMLCollectionOf<HTMLButtonElement>;
...
const gerarTicket = (ticket: string[]) =>{
    let lista = ""
    for(let tick = 0; tick < ticket.length; tick++){
        lista += "<li>" + ticket[tick] + "</li>"
    }
    let botoes = document.getElementsByClassName("botoes") as HTMLCollectionOf<HTMLButtonElement>;
...
const atendimentos = (elementId: string): void => {
    let atnGeral = ""
    let emAtendido = ""
    let clientesEmAtendimento: string[] = []
...
const mostrarAtendidos = (elementId: string) => {
    let listaAtendidos = ""
...
const mostrarAtendidosDois = (elementId: string) => {
    let listaAtendidos = ""
...
const mostrarAtendidosTres = (elementId: string) => {
    let listaAtendidos = ""
